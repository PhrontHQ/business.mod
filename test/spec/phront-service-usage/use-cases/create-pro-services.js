var mainService = require("phront/test/data/client-main.mod/main.mjson").montageObject,
    ...
    PhoneNumber = require("phront/data/main.mod/model/messaging-channel/phone-number").PhoneNumber,
    ...
    Position = require("phront/data/main.mod/model/position").Position,
    EmploymentPosition = require("phront/data/main.mod/model/employment-position").EmploymentPosition,
    EmploymentPositionStaffing = require("phront/data/main.mod/model/employment-position-staffing").EmploymentPositionStaffing,
    EmploymentPositionRelationship = require("phront/data/main.mod/model/employment-position-relationship").EmploymentPositionRelationship,
    EmploymentType = require("phront/data/main.mod/model/employment-type").EmploymentType,
    Role = require("phront/data/main.mod/model/role").Role,
    ContactInformation = require("phront/data/main.mod/model/contact-information").ContactInformation,
    ...
    PersonName = require("phront/data/main.mod/model/person-name").PersonName,
    ProductVariant = require("phront/data/main.mod/model/product-variant").ProductVariant,
    ...
    B2CCustomerSupplierRelationship = require("phront/data/main.mod/model/b-2-c-customer-supplier-relationship").B2CCustomerSupplierRelationship,
    B2BCustomerSupplierRelationship = require("phront/data/main.mod/model/b-2-b-customer-supplier-relationship").B2BCustomerSupplierRelationship,
