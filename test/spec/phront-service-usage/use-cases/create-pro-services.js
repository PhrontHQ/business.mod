var mainService = require("business-data.mod/test/data/client-main.mod/main.mjson").montageObject,
    ...
    PhoneNumber = require("business-data.mod/data/model/messaging-channel/phone-number").PhoneNumber,
    Service = require("business-data.mod/data/model/service").Service,
    ServiceEngagement = require("business-data.mod/data/model/service-engagement").ServiceEngagement,
    Position = require("business-data.mod/data/model/position").Position,
    EmploymentPosition = require("business-data.mod/data/model/employment-position").EmploymentPosition,
    EmploymentPositionStaffing = require("business-data.mod/data/model/employment-position-staffing").EmploymentPositionStaffing,
    EmploymentPositionRelationship = require("business-data.mod/data/model/employment-position-relationship").EmploymentPositionRelationship,
    EmploymentType = require("business-data.mod/data/model/employment-type").EmploymentType,
    Role = require("business-data.mod/data/model/role").Role,
    ContactInformation = require("business-data.mod/data/model/contact-information").ContactInformation,
    ...
    PersonName = require("business-data.mod/data/model/person-name").PersonName,
    ProductVariant = require("business-data.mod/data/model/product-variant").ProductVariant,
    GeoPosition =  require("mod/data/model/geo/position").Position,
    GeoPoint =  require("mod/data/model/geo/point").Point,
    GeoProjection = require("geo.mod/logic/model/projection").Projection,
    B2CCustomerSupplierRelationship = require("business-data.mod/data/model/b-2-c-customer-supplier-relationship").B2CCustomerSupplierRelationship,
    B2BCustomerSupplierRelationship = require("business-data.mod/data/model/b-2-b-customer-supplier-relationship").B2BCustomerSupplierRelationship,
