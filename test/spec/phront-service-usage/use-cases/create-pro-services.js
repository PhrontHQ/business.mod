var mainService = require("business-data.mod/test/data/client-main.mod/main.mjson").montageObject,
    ...
    EmploymentType = require("business-data.mod/data/main.mod/model/employment-type").EmploymentType,
    ...
    ProductVariant = require("business-data.mod/data/main.mod/model/product-variant").ProductVariant,
