...
var cognitoIdentityService = require("phront/data/main.mod/cognito-identity-service.mjson").montageObject,
    UserIdentity = require("phront/data/main.mod/model/app/user-identity").UserIdentity,
