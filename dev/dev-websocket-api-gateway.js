...
.then(function (mr) {
    ...
    dependenciesPromises.push(mr.async("business-data.mod/data/main.mjson"));
    dependenciesPromises.push(mr.async("mod/data/model/data-query"));
    dependenciesPromises.push(mr.async("mod/core/criteria"));
    dependenciesPromises.push(mr.async("business-data.mod/data/service/operation-coordinator"));
