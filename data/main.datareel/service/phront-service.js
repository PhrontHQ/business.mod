var RawDataService = require("montage/data/service/raw-data-service").RawDataService,
    ...
    var params = {
      resourceArn: "arn:aws:rds:us-west-2g:537014313177:cluster:etiama-database", /* required */
      secretArn: "arn:aws:secretsmanager:us-west-2:537014313177:secret:rds-db-credentials/cluster-ONHPYXYIBV7VOTAUYALPIZA25U/postgres-8PggiZ", /* required */
      sql: "select * from phront.\"Collection\"", /* required */
      continueAfterTimeout: false,
      database: 'etiama-database',
...
var etiamaDatabaseSecretArn = "arn:aws:secretsmanager:us-west-2:537014313177:secret:rds-db-credentials/cluster-ONHPYXYIBV7VOTAUYALPIZA25U/postgres-8PggiZ";
var etiamaDatabaseResourceArn = "arn:aws:rds:us-west-2:537014313177:cluster:etiama-database";
...
//Configuration of the RDS instance
var params = {
    secretArn: etiamaDatabaseSecretArn,
    resourceArn: etiamaDatabaseResourceArn,
    database: 'etiama-database', // set a default database
    options: {
        region: "us-west-2",
        // endpoint: "https://rds-data.us-west-2.amazonaws.com",
        endpoint:"https://rds-data.us-west-2.amazonaws.com"
...
//var etiamaDatabaseHost = "https://etiama-database.cluster-ckq195ncztzb.us-west-2.rds.amazonaws.com";
//var etiamaDatabaseHost = "https://rds-data.us-west-2.amazonaws.com";
//var etiamaDatabaseHost = "http://127.0.0.1:5435";
var etiamaDatabaseHost = "https://rds-data.us-west-2.amazonaws.com";


var testRequest = new XMLHttpRequest();
testRequest.open("POST", etiamaDatabaseHost+":8080/Execute");
testRequest.setRequestHeader("Content-type", "application/json");
//request.withCredentials = parsed.credentials;

testRequest.addEventListener("load", function(value) {
    console.log("load event hndler",value);
}, false);
testRequest.addEventListener("error", function(value) {
    console.log("error event hndler",value);
}, false);
testRequest.addEventListener("timeout", function(value) {
    console.log("timeout event hndler",value);
}, false);
testRequest.timeout = 0  ;
...
var queryBody = {
    ...
    "schema": "public",
    "secretArn": etiamaDatabaseSecretArn,
    "sql": "select * from public.\"Collection\";",
    "transactionId": null
 };

 testRequest.send(JSON.stringify(queryBody));


 var postData = JSON.stringify(queryBody);

var httpOptions = {
  hostname: "https://rds-data.us-west-2.amazonaws.com",
  port: "",
  path: '/Execute',
  method: 'POST',
  headers: {
...
exports.PhrontService = PhrontService = RawDataService.specialize(/** @lends OfflineDataService.prototype */ {
    ...
    /*
    CREATE TABLE storephront."TestCreatePGADMIN"
    (
        "A" character varying COLLATE pg_catalog."default"
    )
    WITH (
        OIDS = FALSE
    )
    ...
    ALTER TABLE storephront."TestCreatePGADMIN"
        OWNER to doadmin;
    ...
    */
    ...
    query: {
        value: (...x) => query(config,...x)
    },
    // Transaction method, pass config and parameters
    transaction: {
        value: (x) => transaction(config,x)
    },
